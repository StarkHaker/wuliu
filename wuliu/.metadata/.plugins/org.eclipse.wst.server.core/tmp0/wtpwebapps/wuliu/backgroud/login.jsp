...
<body>
	...
	<form action="${basePath}app/admin" autocomplete="on" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="25" valign="bottom">用户名：</td>
			</tr>
			<tr>
				<td><input id="username" name="username" type="text" class="login_input login_user"
					value="" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td><input id="password" name="password" type="password" class="login_input login_password"
					value="" /></td>
			</tr>
			<tr>
