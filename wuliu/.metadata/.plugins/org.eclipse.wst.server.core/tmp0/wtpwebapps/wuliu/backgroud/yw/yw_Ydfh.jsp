...
<ul class="breadcrumb">当前位置：
  ...
  运单复合
   ...
   <<form action="${basePath}app/yundan/yundanFB" autocomplete="on" method="post">
   <div class="title_right"><strong>订单详情：</strong></div>
   <div style="width:900px; margin:auto">
   <table class="table table-bordered" >
     <tr>
       <td width="12%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">运单号：</td>
       <td width="38%"><input type="text"  id="yundanH" name="yundanH" class="span1-1" value="${Session_yundan.yundanH}" /></td>
     ...
     <tr>
       ...
       <td><input type="text" name="input2" id="input2" class="span1-1"  value="${Session_yundan.yundaFY}"/>元</td>
       <td align="right" bgcolor="#f1f1f1">运单状态：</td>
       <td><input type="text" name="yundaZT" id="yundaZT" class="span1-1" value="${Session_yundan.yundaZT}" /></td>
     </tr>
     <tr>
       <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">货物信息：</td>
       <td><input type="text" name="input7" id="input7" class="span1-1" value="${Session_yundan.huowuXX}"/></td>
       <td align="right" bgcolor="#f1f1f1">货物数量：</td>
        <td><input type="text" name="input5" id="input5" class="span1-1" value="${Session_yundan.huowuSL}" /></td>
     </tr>
         <tr>
       <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">货物重量：</td>
       <td><input type="text" name="input7" id="input7" class="span1-1" value="${Session_yundan.huowuZL}"/></td>
       <td align="right" bgcolor="#f1f1f1">货物大小：</td>
        <td><input type="text" name="input5" id="input5" class="span1-1"  value="${Session_yundan.huowuDX}"/></td>
     </tr>
       <tr>
       <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">装货地点：</td>
       <td><input type="text" name="input7" id="input7" class="span1-1" value="${Session_yundan.zhhuoDD}"/></td>
       <td align="right" bgcolor="#f1f1f1">卸货地点：</td>
        <td><input type="text" name="input5" id="input5" class="span1-1"  value="${Session_yundan.xihuoDD}"/></td>
     </tr>
     <!-- 备注 
      <tr>
   ...
   <table  class="margin-bottom-20 table  no-border" >
        <tr>
     	<td class="text-center"><input type="submit" value="发布" class="btn btn-info " style="width:106px;" /></td>
     	</form>
