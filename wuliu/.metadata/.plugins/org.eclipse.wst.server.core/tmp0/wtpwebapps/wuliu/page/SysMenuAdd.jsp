...
<html lang="zh-CN">
  ...
  <body>
	            ...
	            <div class="panel-body">
	              <form action="" method="post">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" class="form-control" id="Pid" value="">
	                </div>
	                <div class="form-group">
	                  <label for="exampleInputPassword1">菜单地址</label>
	                  <input type="text" class="form-control" id="Murl" value="">
	                </div>
	                <div class="form-group">
	                  <label for="exampleInputPassword1">菜单描述</label>
	                  <input type="text" class="form-control" id="Describe" value="">
	                </div>
    ...
    <form action="${basePath}menu/add_success" method="post" id="addForm">
