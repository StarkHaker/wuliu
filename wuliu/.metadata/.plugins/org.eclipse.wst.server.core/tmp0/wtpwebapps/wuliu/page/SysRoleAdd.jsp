	            ...
	            <div class="panel-body">
	              <form action="" method="post">
	                <div class="form-group">
	                  ...
	                  <input type="text" class="form-control" id="Rname" placeholder="角色名">
	                </div>
	                <div class="form-group">
	                  <label for="exampleInputPassword1">角色代码</label>
	                  <input type="text" class="form-control" id="Rcode" placeholder="角色代码">
	                </div>
	                <div class="form-group">
	                  <label for="exampleInputPassword1">角色描述</label>
	                  <input type="text" class="form-control" id="Describe" placeholder="角色描述">
	                </div>
