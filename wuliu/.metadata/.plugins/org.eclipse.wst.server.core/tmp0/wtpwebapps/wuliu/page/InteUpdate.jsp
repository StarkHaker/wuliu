...
<html lang="zh-CN">
  ...
  <body>
      ...
      <div class="panel-body">
		  ...
		  <div class="col-md-4">
			  <div class="panel panel-success">
	            <div class="panel-heading">兴趣类型修改</div>
	            <div class="panel-body">
	              <form action="" method="post">
	                <div class="form-group">
	                  <label for="exampleInputEmail1">兴趣类型</label>
	                  <input type="text" class="form-control" id="Itype" value="${Inte.itype}">
	                </div>
	                <center><a class="btn btn-success" id="update">Submit</a></center>
	              </form>
	            </div>
	          </div>
		  </div>
    ...
    <form action="${basePath}Inte/update_success" method="post" id="updateForm">
   		 <input type="hidden" id="_Inid" name="inid"  value="${Inte.inid }" />
